...
class QueryQueue {
    constructor(redisQueuePrefix, options) {
        ...
        this.executionTimeout = options.executionTimeout || shared_1.getEnv('dbQueryTimeout');
    ...
    async executeInQueue(queryHandler, queryKey, query, priority, options) {
        ...
        try {
            ...
            const [added, _b, _c, queueSize, addedToQueueTime] = await redisClient.addToQueue(keyScore, queryKey, orphanedTime, queryHandler, query, priority, options);
            if (added > 0) {
        ...
        try {
            ...
            if (query) {
                this.logger('Cancelling query manual', {
                    ...
                    preAggregationId: (_e = (_d = query.query) === null || _d === void 0 ? void 0 : _d.preAggregation) === null || _e === void 0 ? void 0 : _e.preAggregationId,
                    newVersionEntry: (_f = query.query) === null || _f === void 0 ? void 0 : _f.newVersionEntry,
                    preAggregation: (_g = query.query) === null || _g === void 0 ? void 0 : _g.preAggregation,
    ...
    async processQuery(queryKey) {
        var _a, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q, _r, _s, _t, _u, _v, _w, _x, _y, _z, _0, _1, _2;
        const redisClient = await this.queueDriver.createConnection();
        let insertedCount;
        let _removedCount;
        let activeKeys;
            ...
            if (query && insertedCount && activated && processingLockAcquired) {
                ...
                try {
                    ...
                    this.logger('Performing query completed', {
                        ...
                        requestId: query.requestId,
                        timeInQueue,
                        metadata: (_h = query.query) === null || _h === void 0 ? void 0 : _h.metadata,
                        preAggregationId: (_k = (_j = query.query) === null || _j === void 0 ? void 0 : _j.preAggregation) === null || _k === void 0 ? void 0 : _k.preAggregationId,
                        newVersionEntry: (_l = query.query) === null || _l === void 0 ? void 0 : _l.newVersionEntry,
                        preAggregation: (_m = query.query) === null || _m === void 0 ? void 0 : _m.preAggregation,
                        addedToQueueTime: query.addedToQueueTime,
                    });
                }
                catch (e) {
                    ...
                    this.logger('Error while querying', {
                        ...
                        requestId: query.requestId,
                        timeInQueue,
                        metadata: (_o = query.query) === null || _o === void 0 ? void 0 : _o.metadata,
                        preAggregationId: (_q = (_p = query.query) === null || _p === void 0 ? void 0 : _p.preAggregation) === null || _q === void 0 ? void 0 : _q.preAggregationId,
                        newVersionEntry: (_r = query.query) === null || _r === void 0 ? void 0 : _r.newVersionEntry,
                        preAggregation: (_s = query.query) === null || _s === void 0 ? void 0 : _s.preAggregation,
                        addedToQueueTime: query.addedToQueueTime,
                        error: (e.stack || e).toString()
                    });
                    if (e instanceof TimeoutError_1.TimeoutError) {
                        ...
                        if (queryWithCancelHandle) {
                            this.logger('Cancelling query due to timeout', {
                                ...
                                metadata: (_t = queryWithCancelHandle.query) === null || _t === void 0 ? void 0 : _t.metadata,
                                preAggregationId: (_v = (_u = queryWithCancelHandle.query) === null || _u === void 0 ? void 0 : _u.preAggregation) === null || _v === void 0 ? void 0 : _v.preAggregationId,
                                newVersionEntry: (_w = queryWithCancelHandle.query) === null || _w === void 0 ? void 0 : _w.newVersionEntry,
                                preAggregation: (_x = queryWithCancelHandle.query) === null || _x === void 0 ? void 0 : _x.preAggregation,
                ...
                if (!(await redisClient.setResultAndRemoveQuery(queryKey, executionResult, processingId))) {
                    this.logger('Orphaned execution result', {
                        ...
                        queuePrefix: this.redisQueuePrefix,
                        requestId: query.requestId,
                        metadata: (_y = query.query) === null || _y === void 0 ? void 0 : _y.metadata,
                        preAggregationId: (_0 = (_z = query.query) === null || _z === void 0 ? void 0 : _z.preAggregation) === null || _0 === void 0 ? void 0 : _0.preAggregationId,
                        newVersionEntry: (_1 = query.query) === null || _1 === void 0 ? void 0 : _1.newVersionEntry,
                        preAggregation: (_2 = query.query) === null || _2 === void 0 ? void 0 : _2.preAggregation,
                        addedToQueueTime: query.addedToQueueTime,
                    });
                }
                await this.reconcileQueue();
