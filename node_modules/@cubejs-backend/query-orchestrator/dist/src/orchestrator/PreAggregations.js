...
function nowTimestamp(client) {
    var _a, _b;
    return (_b = (_a = client.nowTimestamp) === null || _a === void 0 ? void 0 : _a.call(client)) !== null && _b !== void 0 ? _b : new Date().getTime();
}
...
class PreAggregationLoader {
    ...
    async executeInQueue(invalidationKeys, priority, newVersionEntry) {
        ...
        return query.executeInQueue('query', this.preAggregationQueryKey(invalidationKeys), {
            preAggregation: this.preAggregation,
...
class PreAggregations {
    constructor(redisPrefix, driverFactory, logger, queryCache, options) {
        ...
        this.usedTablePersistTime = options.usedTablePersistTime || shared_1.getEnv('dbQueryTimeout');
        this.externalRefresh = options.externalRefresh;
