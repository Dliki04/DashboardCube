...
class QueryOrchestrator {
    constructor(redisPrefix, driverFactory, logger, options = {}) {
        ...
        this.preAggregations = new PreAggregations_1.PreAggregations(this.redisPrefix, this.driverFactory, this.logger, this.queryCache, {
            ...
            getQueueEventsBus: shared_1.getEnv('preAggregationsQueueEventsBus') &&
    ...
    async fetchQuery(queryBody) {
        ...
        let lastRefreshTimestamp = PreAggregations_1.getLastUpdatedAtTimestamp(preAggregationsTablesToTempTables.map(pa => new Date(pa[1].lastUpdatedAt)));
        if (!queryBody.query) {
            return {
                usedPreAggregations,
        ...
        lastRefreshTimestamp = PreAggregations_1.getLastUpdatedAtTimestamp([lastRefreshTimestamp, (_a = result.lastRefreshTime) === null || _a === void 0 ? void 0 : _a.getTime()]);
        return {
            ...result,
